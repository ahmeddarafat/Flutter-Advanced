...
class LoginViewModel extends BaseViewModel
  ...
  @override
  login() async{
  Either<Failure, AuthenticationModel> either = await _loginUseCase.execute(LoginUseCaseInput(loginObject.userName,loginObject.password));
  ...
  @override
  Stream<bool> get isUserNameValidOutputs => userNameStreamController.stream.map(isUserNameValid);

  @override
  Stream<bool> get isPasswordValidOutputs => passwordStreamController.stream.map(isPasswordValid);
